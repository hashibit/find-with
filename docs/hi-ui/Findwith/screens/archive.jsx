...
const ARCHIVE_MATERIALS = [
  {
    id: 23,
    txt: '入职 60 天主导团队 dev workflow 重构，PR-to-prod 中位 4.2d → 2.6d，覆盖 32 名工程师',
    tag: '主动性',
    company: 'mercury',
    occurred: '2024.07',
    added: '04/12',
    ...
    uses: 2,
    highlight:
      '前两个月就改流程，说明是 builder 型而不是 settler 型——别人在适应公司，你在让公司适应更好的工作方式。',
    raw: '我刚到 Mercury 不到两个月就重写了 PR 合流流程',
    srcType: 'chat',
    src: '2026-04-12 与 Quinn 对话',
    tags: ['主动性', '流程优化', '早期 ownership'],
  },
  {
    id: 22,
    txt: '跨 3 个 product team 推动 onboarding 改版对齐',
    tag: 'Cross-fn',
    company: 'mercury',
    occurred: '2024.09',
    added: '04/12',
  ...
  {
    id: 21,
    txt: '识别重复 oncall 模式，独立 ship 诊断工具，事故复发率 -50%',
    tag: '主动性',
    company: 'notion',
    occurred: '2023 Q4',
    added: '04/08',
    ...
    srcType: 'resume',
    src: '你 2024 年简历 v1 · 第 3 段第 2 条',
  },
  {
    id: 20,
    txt: '主导 RFC，推动支付服务从 MySQL 迁移至 Postgres，p99 -40%',
    tag: '技术深度',
    company: 'notion',
    occurred: '2023.08',
    added: '03/30',
    conf: true,
    uses: 1,
    highlight: '有写 RFC 推大型迁移的经验，能搞定跨团队 buy-in 而不只是写代码。',
    srcType: 'resume',
    src: '你 2024 年简历 v1',
  },
  {
    id: 19,
    txt: '入职第一个月独立完成 Billing webhook 重写',
    tag: '技术深度',
    company: 'notion',
    occurred: '2022.02',
    added: '03/22',
    conf: true,
    uses: 0,
    highlight: '快速 ramp-up——hire 一个月就能独立交付关键模块，可作为 onboarding speed 的论据。',
    srcType: 'chat',
  },
  {
    id: 18,
    txt: '主动接手离职同事的 oncall rotation，无缝衔接 6 周',
    tag: 'Ownership',
    company: 'notion',
    occurred: '2023.05',
    added: '03/15',
    conf: true,
    uses: 1,
    highlight: '团队补位意识——不计 KPI 的事情你也会做。',
    srcType: 'chat',
  },
  {
    id: 17,
    txt: '设计内部 metrics dashboard，被 4 个团队复用',
    tag: '工具思维',
    company: 'byte',
    occurred: '2021 Q3',
    added: '03/08',
    conf: true,
    uses: 2,
    highlight: '造工具的本能——不只解决眼前问题，还想到怎么让别人也能用。',
    srcType: 'resume',
    src: '你 2022 年简历',
  },
  {
    id: 16,
    txt: '独立带 2 个 intern，分别完成各自的 ship-it 项目',
    tag: 'Mentor',
    company: 'mercury',
    occurred: '2024.08',
    added: '02/28',
    conf: true,
    uses: 0,
    highlight: '有带人经验，且不是放养——两个 intern 都 ship 了东西。',
    srcType: 'chat',
  },
  {
    id: 15,
    txt: '用一份数据分析推翻团队"用户想要 X"的直觉，节省 6 周开发',
    tag: 'Data',
    company: 'notion',
    occurred: '2022.11',
    added: '02/14',
    conf: false,
    uses: 0,
    highlight: '敢用数据反对资深同事的直觉——data-informed 不是口号。',
    srcType: 'chat',
  },
  {
    id: 14,
    txt: 'staging 部署时间从 18 分钟优化到 4 分钟',
    tag: '流程',
    company: 'byte',
    occurred: '2021.04',
    added: '02/03',
    conf: true,
    uses: 4,
    highlight: '4.5x 提速 + 高复用率——是个能直接进简历的硬指标。',
    srcType: 'resume',
    src: '你 2022 年简历',
  },
  {
    id: 13,
    txt: '重写 webhook retry 机制，丢失率 0.8% → 0.02%',
    tag: '技术深度',
    company: 'notion',
    occurred: '2023.02',
    added: '01/22',
    conf: true,
    uses: 1,
    highlight: '40x 改善——可靠性工程的硬证据，infra 岗会很买账。',
    srcType: 'resume',
    src: '你 2024 年简历 v1',
  },
  {
    id: 12,
    txt: '推动团队引入 trunk-based dev，code review 周期 -60%',
    tag: '流程',
    company: 'notion',
    occurred: '2023.06',
    added: '01/14',
    conf: true,
    uses: 0,
    highlight: '技术管理能力——不只是写代码，还在改变团队工作方式。',
    srcType: 'chat',
  },
];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
        ...
        <button className="chip soft" style={{ fontSize: 11 }}>
          全部
        </button>
        {COMPANIES.map((c) => (
          ...
          return (
            ...
            >
              ...
              <span
                style={{
                  fontSize: 10.5,
                  color: TAG_COLORS_AR[m.tag] || 'var(--mute)',
                  fontWeight: 500,
                  whiteSpace: 'nowrap',
                  overflow: 'hidden',
                  textOverflow: 'ellipsis',
              ...
              <span
                className={`tnum${m.uses === 0 ? ' muted' : ''}`}
                style={{
                  fontSize: 11,
                  textAlign: 'right',
                  color: m.uses === 0 ? 'var(--mute-2)' : 'var(--ink-2)',
                }}
              >
                {m.uses === 0 ? '—' : m.uses}
              </span>
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px 16px' }}>
          <div>
            ...
            <div className="muted tnum" style={{ fontSize: 10.5, marginTop: 2, paddingLeft: 14 }}>
              {co.period}
            </div>
          </div>
          <div>
            ...
            <div className="tnum" style={{ marginTop: 4, fontSize: 12, color: 'var(--ink)' }}>
              {m.occurred}
            </div>
            <div className="muted tnum" style={{ fontSize: 10.5, marginTop: 2 }}>
              入职 ~ 第 9 周
            </div>
          </div>
          <div>
            ...
            <div className="tnum" style={{ marginTop: 4, fontSize: 12 }}>
              2026.04.12
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          >
            ...
            <span style={{ color: 'var(--accent)', fontSize: 10.5, cursor: 'pointer' }}>
              查看 →
            </span>
          </div>
          {m.raw && (
        ...
        <div>
          ...
          <div style={{ marginTop: 6, display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            >
              ...
              <span className="muted tnum" style={{ fontSize: 10 }}>
                04/14
              </span>
            </div>
            <div
