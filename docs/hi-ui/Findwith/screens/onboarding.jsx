        ...
        <Q qStyle={tweaks.qStyle} qColor={tweaks.aColor}>
          ...
          <div className="qcard" style={{ marginTop: 8 }}>
            <div className="qcard-b" style={{ padding: '10px 12px' }}>
              ...
              <div className="lab" style={{ marginTop: 10, marginBottom: 4 }}>
                工作
              </div>
              <div style={{ fontSize: 12.5, lineHeight: 1.7 }}>
                <div className="h between">
                  <span>Stripe · 后端工程师</span>
                  <span className="muted tnum">'22–'24</span>
                </div>
                <div className="h between">
                  <span>Linear · 产品工程师</span>
                  <span className="muted tnum">'24–今</span>
                </div>
              </div>
    ...
    <Frame variant="b">
      ...
      >
        ...
        <Q qStyle={tweaks.qStyle} qColor={tweaks.bColor}>
          ...
          >
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 13 }}>
              ...
              <span>
                拖入简历，或
                <u style={{ color: 'var(--accent)', textUnderlineOffset: 3 }}>选择文件</u>
              </span>
            </div>
        ...
        <Q qStyle={tweaks.qStyle} qColor={tweaks.bColor}>
          ...
          >
            <div className="lab" style={{ marginBottom: 6, color: 'var(--accent)' }}>
              教育
            </div>
            <div className="serif" style={{ fontSize: 13 }}>
              UCLA · CS B.S. · 2018–2022
            </div>
            <div className="lab" style={{ marginTop: 12, marginBottom: 6, color: 'var(--accent)' }}>
              工作
            </div>
            <div className="serif" style={{ fontSize: 13, lineHeight: 1.8 }}>
              <div className="h between">
                <span>Stripe · 后端工程师</span>
                <span className="muted tnum tiny">'22–'24</span>
              </div>
              <div className="h between">
                <span>Linear · 产品工程师</span>
                <span className="muted tnum tiny">'24–今</span>
              </div>
            </div>
            <div style={{ marginTop: 10, fontSize: 11.5, color: 'var(--mute)' }}>
              <span className="italic">技能：</span> Go · TypeScript · React · Postgres · gRPC ·
              还有 6 项
            </div>
          </div>
        ...
        <Q qStyle={tweaks.qStyle} qColor={tweaks.bColor}>
          <div style={{ fontSize: 13 }}>
            "Product engineer" 这个 title 比较特殊。你日常工作偏前端、后端，还是混合？
          </div>
          <div style={{ display: 'flex', gap: 6, marginTop: 10, flexWrap: 'wrap' }}>
            <button className="btn">前端</button>
            <button className="btn">后端</button>
