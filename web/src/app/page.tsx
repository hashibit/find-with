    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto text-center py-24 px-8">
        <h1 className="font-serif text-5xl font-bold mb-6">
          Your AI career coach.<br/>Right in your browser.
        </h1>
        ...
        <div className="flex gap-4 justify-center">
          <Link href="/install" className="bg-brand-600 text-white px-8 py-3 rounded-lg text-lg hover:bg-brand-700">
            Get Started Free
          </Link>
      ...
      <section className="max-w-5xl mx-auto py-16 px-8 grid md:grid-cols-3 gap-8">
        {[
          { title: 'Deep Profile', desc: 'Quinn builds a career profile from your resume and conversations — not just keywords, real achievements.' },
          { title: 'Truthful Tailoring', desc: 'Every resume bullet traces back to your real experience. No fabrication, ever.' },
          { title: 'Full Pipeline', desc: 'From JD analysis to application to follow-up. Quinn manages the entire flow.' },
        ].map((f) => (
